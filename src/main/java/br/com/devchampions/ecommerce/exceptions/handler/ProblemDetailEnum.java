...
public enum ProblemDetailEnum {
    ...
    INTERNAL_SERVER_ERROR("Inconsistência detectada", URI.create(HttpUrlConstants.BASE_URL_PROBLEMS.concat("/instabilidade-detectada")), HttpStatus.INTERNAL_SERVER_ERROR);
